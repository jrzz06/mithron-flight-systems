...
export function OrderProductThumbnail({
  ...
  return (
    <div
      className={`relative shrink-0 overflow-hidden rounded-lg border border-[var(--platform-border)] bg-gradient-to-br from-[var(--platform-surface-muted)] to-[var(--platform-surface)] ${dimensions.className} ${className}`}
      aria-hidden={!alt}
    >
      {src ? (
