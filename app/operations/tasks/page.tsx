    ...
    <div data-operations-tasks-route>
      ...
      <div className="grid gap-8">
        ...
        <div data-task-action-controls className="grid gap-5">
          <form id="create-task" action={createStaffTaskWithFeedback} data-staff-tasks-table="staff_tasks" className="scroll-mt-24 grid gap-4 rounded-2xl border border-white/10 bg-white/[0.035] p-5">
          ...
          <form action={updateStaffTaskWithFeedback} data-staff-task-status-form className="grid gap-4 rounded-2xl border border-white/10 bg-white/[0.035] p-5">
            <div className="grid gap-4 md:grid-cols-2">
            <label className="grid gap-2 text-sm">
