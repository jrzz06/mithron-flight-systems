...
export default async function VideoDronesPage() {
  const [catalog, products] = await Promise.all([getCategoryCmsMetadata("videoDrones"), getProductsForCatalog("videoDrones")]);
