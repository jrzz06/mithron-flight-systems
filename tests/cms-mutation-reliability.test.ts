...
describe("CMS mutation reliability", () => {
  ...
  it("surfaces CMS form mutation results in admin actions and workspace UI", () => {
    ...
    const homepageEditorSource = readFileSync(join(process.cwd(), "features", "admin", "cms", "homepage-cms-editor.tsx"), "utf8");
    ...
    expect(homepageEditorSource).toContain("saveHeroBannerDraftFormAction");
  });
