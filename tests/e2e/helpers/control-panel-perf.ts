...
export const CONTROL_PANEL_TRANSITIONS: ControlPanelTransition[] = [
  ...
  { id: "admin-orders-cms", panel: "admin", from: "/admin/orders", to: "/admin/cms", readySelector: "[data-admin-cms-route], [data-homepage-cms-editor]" },
  ...
  { id: "warehouse-dashboard-stock", panel: "warehouse", from: "/warehouse/dashboard", to: "/warehouse/inventory", readySelector: "[data-warehouse-inventory-route]" },
  { id: "warehouse-orders-stock", panel: "warehouse", from: "/warehouse/orders", to: "/warehouse/inventory", readySelector: "[data-warehouse-inventory-route]" },
